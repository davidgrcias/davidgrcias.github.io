        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
            ...
            {isTyping && (
                <div className="flex justify-start">
                     <div className="bg-white px-4 py-3 rounded-2xl rounded-bl-sm border border-gray-200 shadow-sm flex gap-1 items-center">
        ...
        <div className="p-4 bg-white border-t border-gray-200">
            <form onSubmit={handleSend} className="relative flex items-center gap-2">
                <input
                    ...
                    className="flex-1 bg-gray-100 text-gray-900 border-0 rounded-full py-2 px-4 focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all outline-none placeholder-gray-400"
                />
                <button 
                    type="submit"
